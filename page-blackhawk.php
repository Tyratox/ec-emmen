					...
					<div class="w-full md:w-1/5">
						<div class="flex flex-wrap">
							<div class="w-1/2 md:w-full mb-4">
								<img class="h-32 w-auto mx-auto md:mx-0 md:h-24 mb-8 md:mb-0 lg:h-32" src="<?php echo get_template_directory_uri() . "/images/blackhawks-logo-red.png"; ?>">
							</div>
							
							<div class="text-white font-bold w-1/2 md:w-full">
								<?php
						  			wp_nav_menu(
							  			array(
